...
<p className='p-medium-16 rounded-full bg-gray-500/10 px-4 py-2.5 text-gray-500'>
  ...
  by{''}
  <span className='text-violet-500' > {event.organizer.firstName} {event.organizer.lastName} </span>
...
<div className='flex flex-col gap-2'>
  ...
  <p className='p-medium-16 lg:p-regular-18 truncate text-violet-500 underline'> {event.url} </p>
